...
- The Luna Lab Launchpad for Creativity, Project Management, and Soft Skill Development: In the summer, we take a break from regularly scheduled data meetings to touch on important topics that don't normally have a forum for discussion. These include things like how to assemble figures, how to network, how to give a really great talk, the many ways of reading a paper, ideation on creativity and improvisation, and what to do if you're in a project rut, among many other topics. Our source matierial for these sessions are varied, but a good general inspiration are the [Night Science Podcasts](https://nightscience.buzzsprout.com/). We assemble our notes in a shared resource available to all lab members. The goal of collaborative meetings on process is to help guide all of us toward better science habits.
